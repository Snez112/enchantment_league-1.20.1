            ...
            if (matchesEndCity || matchesNetherBridge || matchesAncientCity) {
                ...
                LootPool.Builder poolBuilder = LootPool.builder()
                    ...
                    .with(ItemEntry.builder(Items.ENCHANTED_BOOK)
                        .weight(5)
                        .apply(new SetEnchantmentsLootFunction.Builder()
                            .enchantment(ModEnchantments.LETHALITY, UniformLootNumberProvider.create(1, ModConfig.INSTANCE.lethality.max_level))
                        )
                    )
                    .with(ItemEntry.builder(Items.ENCHANTED_BOOK)
                        .weight(3)
                        .apply(new SetEnchantmentsLootFunction.Builder()
                            .enchantment(ModEnchantments.INFINITY_ASPECT, UniformLootNumberProvider.create(1, ModConfig.INSTANCE.infinity_aspect.max_level))
                        )
                    )
                    .with(ItemEntry.builder(Items.ENCHANTED_BOOK)
                        .weight(4)
